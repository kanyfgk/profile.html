...
const WelcomeApp = {
    ...
    openMobileAuth(screen){
        ...
        /*
         * Do not scroll the viewport.
         * Only focus on larger screens where
         * opening the keyboard is not relevant.
         */
        if(
            emailInput &&
            window.matchMedia(
        ...
        screen.addEventListener(
            ...
            event => {
                ...
                if(
                    ...
                    /*
                     * Authentication provider will
                     * eventually sit here.
                     *
                     * For the current Engine prototype,
                     * entering the account flow continues
                     * into Discovery.
                     */
    ...
    render(){
                            ...
                            <article class="welcome-feature">
                                ...
                                >
                                    <svg viewBox="0 0 48 48">
                                        ...
                                        <path
                                            d="M20 8a7 7 0 0 0-7 7v1a7 7 0 0 0-3 12 7 7 0 0 0 7 8h3V8Z"
                                        ></path>

                                        <path
                                            d="M28 8a7 7 0 0 1 7 7v1a7 7 0 0 1 3 12 7 7 0 0 1-7 8h-3V8Z"
                                        ></path>

                                        <path
                                            d="M20 16c-4 0-6 2-6 5"
                                        ></path>

                                        <path
                                            d="M28 16c4 0 6 2 6 5"
                                        ></path>

                                        <path
                                            d="M20 27c-4 0-6 2-6 5"
                                        ></path>

                                        <path
                                            d="M28 27c4 0 6 2 6 5"
                                        ></path>
                            ...
                            <article class="welcome-feature">
                                ...
                                >
                                    <svg viewBox="0 0 48 48">
                                        ...
                                        <path
                                            d="M24 4 40 10v12c0 10-6.5 17.5-16 22C14.5 39.5 8 32 8 22V10L24 4Z"
                                        ></path>
                                ...
                                <div>
                                    ...
                                    <p>
                                        Tüm varlıkların güvende
                                        ve senin yönetiminde.
                                    </p>
        ...
        /*
         * Prevent the information link from
         * jumping the viewport to the top.
         */
