...
entityOrgans(entity){
    ...
    return this.renderAppSafely(
        ...
        "Varlık Sistemleri uygulaması yüklenemedi."
...
entityTimeline(entity){
    ...
    return this.renderAppSafely(
        ...
        "Zaman Çizelgesi uygulaması yüklenemedi."
...
entityBridge(entity){
    ...
    return this.renderAppSafely(
        ...
        "Bağlantılar uygulaması yüklenemedi."
...
entityEvolution(entity){
    ...
    return this.renderAppSafely(
        ...
        "Gelişim uygulaması yüklenemedi."
